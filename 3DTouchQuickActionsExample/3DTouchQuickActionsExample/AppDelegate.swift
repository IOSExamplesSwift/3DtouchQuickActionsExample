...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let shortcut3 = UIMutableApplicationShortcutItem(type: "AddMusic", localizedTitle: "Add Track", localizedSubtitle: "Add a track to playlist", icon: UIApplicationShortcutIcon(type: .add), userInfo: nil)
        
        let shortcut4 = UIMutableApplicationShortcutItem(type: "PauseMusic", localizedTitle: "Pause", localizedSubtitle: "Pause playback", icon: UIApplicationShortcutIcon(type: .pause), userInfo: nil)
